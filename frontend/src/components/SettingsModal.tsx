          ...
          <div className="flex-1 overflow-y-auto p-10 scrollbar-thin scroll-smooth focusable-container" tabIndex={0}>
            ...
            {activeTab === 'memory' && (
              <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
                {/* Main resync card */}
                <div className="bg-jb-purple/5 border border-jb-purple/20 rounded-[32px] p-8 flex flex-col gap-6">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-2xl bg-jb-purple/20 flex items-center justify-center border border-jb-purple/30 text-jb-purple shadow-[0_0_30px_rgba(157,91,210,0.2)] flex-shrink-0">
                      <Database size={22} />
                    </div>
                    <div>
                      <h4 className="text-base font-black text-white tracking-tight">Resync Project Memory</h4>
                      <p className="text-xs text-slate-500 font-bold leading-relaxed mt-0.5">
                        Scans your workspace files and builds a semantic index so all AI modes can reference your project context automatically.
                      </p>
                    </div>
                  </div>
                  <div className="flex justify-end">
                    <button
                      ...
                      className="px-8 py-3 bg-white text-black rounded-2xl font-black text-[10px] uppercase tracking-widest hover:scale-105 active:scale-95 transition-all shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:scale-100 flex items-center gap-2"
                    >
                ...
                <div className="bg-white/[0.01] border border-white/5 rounded-3xl p-6 opacity-30 pointer-events-none flex items-center gap-4">
                  <Database size={20} className="text-slate-600 flex-shrink-0" />
                  <div>
                    <span className="text-xs font-black text-white block">Clear Memory Index</span>
                    <span className="text-[10px] text-slate-600">Wipe and rebuild from scratch — coming soon</span>
                  </div>
                </div>
              </div>
            )}
