...
import { 
  ...
  Users, FlaskConical, ScanEye, Search, BookOpen, LineChart, ChevronRight, Settings 
} from 'lucide-react';
import { cn } from '../lib/utils';
import { motion } from 'framer-motion';

export const Navigation = () => {
  const { currentMode, setCurrentMode, setSettingsOpen } = useAppStore();
    ...
    <div className="w-72 h-full bg-black/40 backdrop-blur-3xl border-r border-white/5 flex flex-col relative z-20">
        ...
        <div className="flex items-center gap-4 group cursor-pointer">
           ...
           >
              ...
              <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-[0_0_15px_rgba(244,63,94,0.5)]">
                 ...
                 {/* Flask Body */}
                 <path 
                    d="M38 20 L38 45 L18 82 Q15 88 22 88 L78 88 Q85 88 82 82 L62 45 L62 20 Z" 
                    fill="none" 
                    stroke="white" 
                    strokeWidth="2" 
                    strokeOpacity="0.15" 
                 ...
                 <motion.path 
                    animate={{ 
                       d: [
                          ...
                          "M40 46 L25 80 Q23 83 27 83 L73 83 Q77 83 75 80 L60 46 Q58 43 50 43 Q42 43 40 46 Z",
                          "M40 48 L25 80 Q23 83 27 83 L73 83 Q77 83 75 80 L60 48 Q58 45 50 45 Q42 45 40 48 Z"
                       ]
                    }}
                    transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
                    d="M40 48 L25 80 Q23 83 27 83 L73 83 Q77 83 75 80 L60 48 Q58 45 50 45 Q42 45 40 48 Z" 
      ...
      <div className="flex-1 overflow-y-auto px-6 space-y-10 scrollbar-hide">
        ...
        <div className="space-y-1.5">
          <p className="px-4 text-[9px] font-black text-slate-600 uppercase tracking-[0.3em] mb-4 opacity-40">Modes</p>
      ...
      <div className="p-8">
        <div className="bg-white/[0.03] border border-white/5 rounded-[24px] p-5 backdrop-blur-md relative overflow-hidden group">
           ...
           <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                 <span className="text-[11px] font-bold text-slate-400">DeepSeek</span>
                 <span className="text-[10px] font-black text-jb-purple px-2 py-0.5 bg-jb-purple/10 rounded-md border border-jb-purple/20 tracking-wider uppercase">V3 Active</span>
              </div>
           </div>
        ...
        <div className="mt-6">
           <motion.button
             ...
             className="w-full flex items-center gap-3 px-4 py-3 rounded-2xl text-slate-500 hover:text-white transition-all group"
           >
