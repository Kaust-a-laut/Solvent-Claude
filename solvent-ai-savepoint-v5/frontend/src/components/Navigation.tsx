        ...
        <div className={cn("flex items-center group cursor-pointer", isCollapsed ? "justify-center" : "gap-4")}>
           ...
           >
              <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-[0_0_15px_rgba(244,63,94,0.5)]">
                 ...
                 <motion.path 
                    animate={{ d: ["M40 48 L25 80 Q23 83 27 83 L73 83 Q77 83 75 80 L60 48 Q58 45 50 45 Q42 45 40 48 Z", "M40 46 L25 80 Q23 83 27 83 L73 83 Q77 83 75 80 L60 46 Q58 43 50 43 Q42 43 40 46 Z", "M40 48 L25 80 Q23 83 27 83 L73 83 Q77 83 75 80 L60 48 Q58 45 50 45 Q42 45 40 48 Z"] }}
