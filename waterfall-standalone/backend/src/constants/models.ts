...
export const WATERFALL_PRESETS: Record<string, WaterfallPreset> = {
  ...
  'groq-speed': {
    name: 'Groq Speed',
    description: 'All-Groq pipeline + Healer reviewer. Healer score: 85-95. Fastest honest pipeline.',
    selection: {
      architect: { model: 'openai/gpt-oss-120b', provider: 'groq' },
  ...
  'gemini-review': {
    ...
    selection: {
      ...
      reviewer:  { model: 'gemini-3.1-pro-preview', provider: 'gemini' },
    },
  },
  'maverick': {
    name: 'Maverick',
  ...
  'glm-kimi': {
    name: 'GLM-Kimi',
    description: 'GLM-4.7 architects, Kimi K2.5 reasons, Kimi K2 executes. Highest hard-prompt score (87). Strong + fast.',
    selection: {
